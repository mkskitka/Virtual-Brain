...
export const de_bio = 
`Volvox Labs and I worked with Drunk Elephant to create an immersive hair-care quiz kiosk. 
...
animated visuals that bring to life the mixology of the product.`;

export const wild_birds_bio = 
`Wild Birds x was a two part show series that pairs multi-wall projection & vj-ing (visual jockeying)
with live band/dj sets  As a co-producer on the project, I worked closely with the the owners and technical staff 
of Brooklyn Art Haus to set up the multiwall projection and vj system. I promoted and oversaw the events.`

export const cc_bio = 
`Creative Coding is a reflection on coding as a process and embodied experience. 
It's form is a movement interface to code that uses the live code langauge, sonic pi, a rasperberry pi, and arduino. 
The custom built handheld device allows me to perform coding wirelessly, without internet. 
The arduino IMF classifies movement data which is converted to code and executed in real time.`

export const photobooth_bio = `A customized interactive photobooth created with touch designer, 
kinect, and a web application. 
I worked with the client to match the filters to the theme of the wedding. 
The product allows for a more engaging photobooth expereince. Many users dance to stir
 up the reactive visals resulting in a candid and fun photo series.`

export const crt_bio = 
`A mult-output a/v interactive installation utilizing 12 found crt tv's.
